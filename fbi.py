...
def baliho():
	try:
		...
		print R + ''.center(44)
		print "".center(44)
		print 'Fernando Castillo'.center(44)
		print 'Fernando Castillo'.center(44)
		print ' ' + W
		print ('Fernando Castillo').center(44)
		print (W + '     [' + G +'FerHack'+ W + ']')
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    CREADOR     Fernando Castillp
    NOMBRE       FerHack
    Version    Full Version
    FECHA       11/05/2019 
    CONTACTO     yisusxd2000@gmail.com

* SI HAY ERRORES , FAVOR DE CONTACTARME A MI CORREO 
'''%(G,W)
def info_ga():

	print '''
     %sCOMMANDOS                      FUNCION%s
  -------------       -------------------------------------

   get_data           Examinar Amigos
   get_info           Sacar informacion de un amigo

   dump_id            Sacar ID de mis amigos
   dump_phone         Sacar numeros de telefonos de mis amigos
   dump_mail          Sacar correos de mis amigos
   dump_<id>_id       fetching all id from your friends <spesific>
		      ex: dump_username_id

   token              Generar acceso 
   cat_token          Otro
   rm_token           Remover acceso
...
def menu_bot():
 ...
 ---------   ------------------------------------
   ...
   [ 02 ]      Auto comentar
   [ 03 ]      Compartir
   [ 04 ]      Acepat solicitudes
   [ 05 ]      Borrar publicaciones
   [ 06 ]      Borrar amigos
   [ 07 ]      Dejar de seguir
   [ 08 ]      Borrar fotos
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'FerHack' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'FerHack' + W +'/' + R +'Bot ' + W + '>> ')
